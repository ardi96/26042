...
ZZ01H8     03 TABDEL OCCURS 20
ZZ01H8         05 REFLOT-DEL              PIC X(10).
ZZ01H8         05 NUMTEC-DEL              PIC X(06).
...
ZZ01X8  MOVE "N"                  TO SWIDEL OF WORKER. 
...
ZZ01X8* Check if program reach another "0" and one of the "1" record
ZZ01X8* is in error (SWIDEL=Y) then delete those records 
ZZ01X8* and execute Auto Splitting

ZZ01X8         IF SWIDEL OF WORKER = "Y"
   
ZZ01X8* Notes:    I3 sudah dipakai di atas, mungkin value berubah
ZZ01X8            MOVE I3 OF WORKER             TO SWIMAX OF WORKER
ZZ01X8            PERFORM DELETE-AGD06 THRU DELETE-AGD06-FN
ZZ01X8*
ZZ01X8*           check if any errors occur   
ZZ01X8*
ZZ01X8            PERFORM AUTO-SPLITTING THRU AUTO-SPLITTING-FN 
ZZ01X8         END-IF
ZZ01X8         
ZZ01X8         MOVE "N"                    TO SWIDEL OF WORKER
...
ZZ01X8          MOVE "Y"                   TO SWIDEL OF WORKER
...
ZZ01H8*--------------*
ZZ01H8
ZZ01H8    MOVE 1     TO                        I1 OF WORKER.
ZZ01H8    PERFORM VARYING I3 FROM 1 BY 1 UNTIL I3 > SWIMAX OF WORKER
ZZ01H8      INITIALIZE AGD06-01
ZZ01H8      MOVE  REFLOT-DEL OF WORKER(I1) TO REFLOT OF AGD06-01
ZZ01H8      MOVE  NUMTEC-DEL OF WORKER(I1) TO NUMTEC OF AGD06-01
ZZ01H8      @READZ,"1",AGD06-01,XX
ZZ01H8      IF ACCESS-OK 
ZZ01H8         @DELETE,AGD06-01,XX
ZZ01H8      END-IF   
ZZ01H8    END-PERFORM.

ZZ01H8 DELETE-AGD06-FN.
ZZ01H8*--------------*
ZZ01H8     EXIT. 


ZZ01H8 AUTO-SPLITTING.
ZZ01H8*------------------*

ZZ01H8 AUTO-SPLITTING-FN.
ZZ01H8*------------------*
ZZ01H8      EXIT. 
